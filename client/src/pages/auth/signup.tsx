...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:items-center md:justify-center md:p-6 relative overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col w-full md:flex-none md:w-full md:max-w-2xl md:rounded-3xl md:shadow-2xl md:overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <img src="/logo-full.png" alt="JobTradeSasa" className="h-28 w-auto max-w-[280px] object-contain mx-auto mb-2 drop-shadow-xl" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
